...
public class SettingsActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profileImageView=(CircleImageView) findViewById(R.id.profile_image_settings );
        ...
        updateTextBtn=(TextView) findViewById(R.id.update_settings_btn);

        userInfoDisplay(profileImageView,fullNameEditText,phoneEditText,addressEditText,profileChangeTextBtn,closeTextBtn,updateTextBtn);
    ...
    private void userInfoDisplay(final CircleImageView profileImageView, final EditText fullNameEditText, final EditText phoneEditText, final EditText addressEditText, TextView profileChangeTextBtn, TextView closeTextBtn, TextView updateTextBtn)
    {
